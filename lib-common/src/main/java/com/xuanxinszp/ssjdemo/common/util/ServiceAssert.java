...
import com.xuanxinszp.ssjdemo.common.web.ResponseHeader;
...
public abstract class ServiceAssert {
	...
	public static void isTrue(boolean expression, String desc) throws AppException {
		if (!expression) {
			ResponseHeader response = ResponseHeader.newInstance(StandardResponseHeader.ERROR.getCode(), desc);
			throw new AppException(response);
		}
	}
