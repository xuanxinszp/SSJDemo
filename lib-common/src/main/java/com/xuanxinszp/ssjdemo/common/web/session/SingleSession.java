package com.xuanxinszp.ssjdemo.common.web.session;
...
import com.xuanxinszp.ssjdemo.common.cache.HashCache;
...
public abstract class SingleSession<U extends UUIDEntity> extends HashCache implements HandlerInterceptor {
    ...
    public static String COOKIE_SESSION_ID = "SessionID_EWSO";
    /**
     * 当前线程所对应的sessionId
     */
