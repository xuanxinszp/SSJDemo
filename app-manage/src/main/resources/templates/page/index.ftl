                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">E管理系统</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">JIA
                    </div>
                </li>
...
<script type="text/javascript">
    ...
    function  createMenuListHmtl(menuList) {
        ...
        for(var i = 0;i < menuList.length;i++)
        {
            ...
            listHmtl += '<li>';
            listHmtl += '<a href="#"><i class="fa fa fa-cog"></i><span class="nav-label">'+firstMenuItem.menu.name+'</span><span class="fa arrow"></span></a>';
