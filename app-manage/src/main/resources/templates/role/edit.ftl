                                            ...
                                            <li id="p_${pg.code}" data-jstree='{"opened":true}'>${pg.name}
                                                <ul>
                                                    <#list pg.permissions as p>
                                                        <li id="${p.code}" data-jstree='{<#if p.have>"selected":true,</#if>"type":"file"}'>${p.name}
                                                            <ul>
                                                                <#list p.buttons as b>
                                                                    <li id="${b.code}" data-jstree='{<#if b.have>"selected":true,</#if>"type":"button"}'>${b.name}</li>
                                                                </#list>
                                                            </ul>
                                                        </li>
                                                    </#list>
...
<script type="text/javascript">
    $('#checkTree').jstree({
        ...
        'types' : {
            ...
            'button' : {
                'icon' : 'fa fa-tag icon-state-info icon-md'
            }
        },
