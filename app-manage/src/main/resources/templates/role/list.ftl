        ...
        $("#table_list").bootstrapTable({
            ...
            columns: [ {
                ...
                formatter: function (value, row, index) {
                    ...
                    if(row.status==10){
                        operateHtml = operateHtml + ' <br/><br/> <button class="btn btn-success btn-xs" type="button" onclick="stop(\''+row.id+'\')"><i class="fa fa-first-order"></i>&nbsp;停用</button>';
                    }else{
                        operateHtml = operateHtml + ' <br/><br/> <button class="btn btn-success btn-xs" type="button" onclick="activate(\''+row.id+'\')"><i class="fa fa-first-order"></i>&nbsp;启用</button>';
                    }
                    return operateHtml;
                }
            }]
