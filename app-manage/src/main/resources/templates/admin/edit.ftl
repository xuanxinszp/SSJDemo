                    ...
                    <form class="form-horizontal m-t" id="frm" enctype="multipart/form-data" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input id="new_password" name="new_password" value="${(admin.password)!''}" class="form-control" type="password">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="status">
                                    <option value="10" <#if admin.status == 10>selected</#if> >正常</option>
                                    <option value="-10" <#if admin.status == -10>selected</#if> >停用</option>
                                </select>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function pwdHandler() {
        var oldPwd = "${(admin.password)!''}";
        var newPwd = $("#new_password").val();
        if(oldPwd==newPwd) {
            console.log("oldPwd equals newPwd is ture.");
            $("#password").val('');
        } else {
            $("#password").val(newPwd);
        }
