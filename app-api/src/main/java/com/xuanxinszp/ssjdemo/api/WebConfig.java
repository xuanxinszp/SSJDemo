...
import com.xuanxinszp.ssjdemo.common.web.*;
import com.xuanxinszp.ssjdemo.api.auth.bean.AuthInterceptor;
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addAllExceptGlobalFunctionPage(registry,authInterceptor);
    }
