package com.xuanxinszp.ssjdemo.api.user.cache;


import com.xuanxinszp.ssjdemo.api.user.dto.TokenSessionDto;
import com.xuanxinszp.ssjdemo.common.cache.AbstractCache;
import com.xuanxinszp.ssjdemo.common.cache.CacheConstant;
...
public class TokenSessionCache extends AbstractCache<String> {
    ...
    public Long getUserId(){
        Long userId = (null != getUserToken() && null != getUserToken().getUser()) ? getUserToken().getUser().getId() : null;
        if (userId == null ) throw new AppException("用户ID为空");
        return userId;
    }
